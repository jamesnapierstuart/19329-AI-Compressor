			...
			analyseButton.action_({arg b;
				...
				{(soundFile != nil) && (isAnalysing == false)} {
					...
					analyisClassificationRoutine = {
						...
						classifiedPeriodicity = InstrumentClassificationPeriodicNonPeriodic(Platform.resourceDir +/+ "machineLearningCSVs/Even Non:Periodic Training Onset/periodicTrainingOnset/PeriodicTrainingOnset.csv", Platform.resourceDir +/+ "machineLearningCSVs/Even Non:Periodic Training Onset/nonPeriodicTrainingOnset/nonPeriodicTrainingOnset.csv", 25, soundPath, Onsets);
						...
						{classifiedPeriodicity.getClassifiedInstrument == "NonPeriodic"} {
							...
							classifiedInstrument = KickSnareClassificationOnsetTartini(Platform.resourceDir +/+ "machineLearningCSVs/UnEven MultiClass Tartini/kickTrainingTartini.csv", Platform.resourceDir +/+ "machineLearningCSVs/UnEven MultiClass Tartini/snareTrainingTartini.csv", 25, soundPath, Tartini);
						}
						// Else periodic
						{
							...
							classifiedInstrument = EguitarVocalClassificationMFCC(Platform.resourceDir +/+ "machineLearningCSVs/MFCC Even/EguitarMFCCTrainingData.csv", Platform.resourceDir +/+ "machineLearningCSVs/MFCC Even/VocalMFCCTrainingData.csv", soundPath);
						};
